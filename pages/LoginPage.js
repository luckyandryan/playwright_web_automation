...
export class LoginPage extends BasePage {
    constructor(page) {
        super(page);
        this.welcomeHeader = '//div[contains(@style, "margin-bottom: 50px")]//h2[text()="Welcome,"]';
        this.loginSubHeader = '//div[contains(@style, "margin-bottom: 50px")]//h5[text()="Login in Book Store"]';
        this.userNameInput = '//*[@id="userName"]';
        this.passwordInput = '//*[@id="password"]';
        this.loginButton = '//*[@id="login"]';
        this.invalidCredentialsMessage = '//p[@id="name" and text()="Invalid username or password!"]';
    }
