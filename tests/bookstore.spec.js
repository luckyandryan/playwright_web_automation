...
test.describe('Bookstore UI Tests', () => {
    ...
    test('Verify profile page when not logged in', async ({ page }) => {
        ...
        expect(notLoggedInText).toContain('not logged into the Book Store application');
    });

    test('Verify login with invalid credentials shows error message', async ({ page }) => {
    ...
    test('Verify search using publisher name works correctly', async ({ page }) => {
